...
/*   Updated: 2026/06/15 19:48:58 by bshbool          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	init_table(char **argv, t_table *table)
{
	...
	if (table->eat_time == 0 || table->sleep_time == 0)
		exit_error("Invalid arguments: times cannot be zero");
	if (argv[5])
